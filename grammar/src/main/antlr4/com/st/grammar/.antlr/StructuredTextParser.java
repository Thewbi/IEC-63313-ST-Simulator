...
public class StructuredTextParser extends Parser {
	...
	public final Function_block_declarationContext function_block_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32704L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & -9223090561877802871L) != 0)) {
				{
				setState(441);
				function_block_body();
				}
	...
	public final Var_declarationsContext var_declarations() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32704L) != 0) || ((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 2199025352705L) != 0)) {
				{
				setState(802);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public final Fb_invocationContext fb_invocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2666060744876916688L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 65011745L) != 0)) {
				{
				setState(1166);
				param_assignment();
				setState(1171);
