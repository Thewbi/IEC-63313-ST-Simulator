...
public class StructuredTextParser extends Parser {
	...
	public static final int
		...
		END_TYPE=103, END_STRUCT=104, FUNCTION=105, FUNCTION_BLOCK=106, INTERFACE=107, 
		IMPLEMENTATION=108, MINUS=109, METHOD=110, NON_RETAIN=111, OF=112, PERSISTENT=113, 
		PLUS=114, PROGRAM=115, PUBLIC=116, RETAIN=117, RETURN=118, SEMICOLON=119, 
		STRUCT=120, TICK=121, TYPE=122, TASK=123, UNDERSCORE=124, VAR=125, VAR_EXTERNAL=126, 
		VAR_INPUT=127, VAR_OUTPUT=128, VAR_GLOBAL=129, BINARY_INTEGER=130, BOOLEAN_EXPLICIT_LITERAL=131, 
		INTEGER=132, IDENTIFIER=133, STRING_LITERAL_SINGLE_QUOTE=134, UNTERMINATED_STRING_LITERAL_SINGLE_QUOTE=135, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"END_PROGRAM", "END_VAR", "END_TYPE", "END_STRUCT", "FUNCTION", "FUNCTION_BLOCK", 
	...
	public final Compilation_unitContext compilation_unit() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 1082155009L) != 0)) {
				{
				{
				setState(326);
	...
	public final Function_block_declarationContext function_block_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 71)) & ~0x3f) == 0 && ((1L << (_la - 71)) & 4611826755916005513L) != 0)) {
				{
				setState(441);
				function_block_body();
				}
	...
	public final Var_declarationsContext var_declarations() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 93)) & ~0x3f) == 0 && ((1L << (_la - 93)) & 1099512676353L) != 0)) {
				{
				setState(802);
				_errHandler.sync(this);
				_la = _input.LA(1);
