...
public class StructuredTextParser extends Parser {
	...
	public static final int
		...
		VAR=125, VAR_EXTERNAL=126, VAR_INPUT=127, VAR_OUTPUT=128, VAR_IN_OUT=129, 
		VAR_GLOBAL=130, BINARY_INTEGER=131, BOOLEAN_EXPLICIT_LITERAL=132, INTEGER=133, 
		IDENTIFIER=134, STRING_LITERAL_SINGLE_QUOTE=135, UNTERMINATED_STRING_LITERAL_SINGLE_QUOTE=136, 
		STRING_LITERAL=137, UNTERMINATED_STRING_LITERAL=138, NEWLINE=139, WS=140;
	public static final int
	...
	public final Function_declarationContext function_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 125)) & ~0x3f) == 0 && ((1L << (_la - 125)) & 29L) != 0)) {
				{
				setState(368);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final Function_block_declarationContext function_block_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32704L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 281474976972937L) != 0) || _la==IDENTIFIER) {
				{
				setState(453);
				function_block_body();
				}
	...
	public final Var_declarationsContext var_declarations() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 32704L) != 0) || ((((_la - 92)) & ~0x3f) == 0 && ((1L << (_la - 92)) & 4398048608257L) != 0)) {
				{
				setState(851);
				_errHandler.sync(this);
				_la = _input.LA(1);
	...
	public final Array_initial_elementsContext array_initial_elements() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 144044953549406224L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 130023457L) != 0)) {
					{
					setState(1115);
					array_initial_element();
					}
	...
	public final Fb_invocationContext fb_invocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2666060744876916688L) != 0) || ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 130023457L) != 0)) {
				{
				setState(1215);
				param_assignment();
				setState(1220);
	...
	public final Case_statementContext case_statement() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 109)) & ~0x3f) == 0 && ((1L << (_la - 109)) & 54525985L) != 0) );
			setState(1439);
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==T__79) {
